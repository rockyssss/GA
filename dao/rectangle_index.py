...
TYPE_NAME_ARR = np.array(['麻醉准备间 ', '麻醉恢复区 ', '精密仪器室 ', '无菌包储存室 ', '一次性物品储存室 ', '体外循环室 ', '麻醉用品库 ', '总护士站 ', '快速灭菌', '腔镜洗消间',
         '家属等候区 ',
...
TYPE_ARR = np.array([51441115, 51443500, 51442113, 51172100, 51171300, 51348400, 51441100, 51172311, 51578800, 51442115, 51443300,
...
TYPE_NAME_DICT = {}
for index in range(len(TYPE_NAME_ARR)):
    TYPE_NAME_DICT[TYPE_ARR[index]] = TYPE_NAME_ARR[index]
